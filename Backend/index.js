...
const address = "103-20 LIBERTY AVENUE, 11417";
...
const createZolaLotLink = (bbl, coordinates, zoomLevel = 19.21) => {
  try {
    ...
    const coords = `${zoomLevel}/${latitude}/${longitude}/0/60`;
...
(async () => {
  ...
  console.log("zolaLink",zolaLink)
  if (zolaLink) {
    console.log("ZOLA Link:", zolaLink);
    const scrapedData = await scrapeData(zolaLink);
    console.log("Scraped Data:", scrapedData);
  } else {
    console.log("Failed to generate ZOLA link.");
  }
})();
